...
import { subscribeLotDetails, getLotDetails } from '../../content/lot-details-store'
  ...
  return (
    <div className="calculator">
      ...
      <div>
        {lotDetails && (
          <div
            style={{ padding: '12px', background: 'rgba(255,255,255,0.1)', borderRadius: '8px', marginBottom: '16px' }}
          >
